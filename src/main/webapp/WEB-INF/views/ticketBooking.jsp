...
<body style="background-color: rgb(200, 240, 300)">
	...
	<td>
	<sf:input path="customerName" id="customerName"/></td>
	<td>
	<sf:errors path="customerName" cssStyle="color:red;"></sf:errors>
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>
	<sf:input path="mobileNumber" id="mobileNumber"/></td>
	<td>
	<sf:errors path="mobileNumber" cssStyle="color:red;"></sf:errors>
	</td>
	</tr>
	<tr>
	<td>
	...
	<td>
	<sf:errors path="noOfTickets" cssStyle="color:red;"></sf:errors>
	</td>
	</tr>
	<tr>
	<td>
